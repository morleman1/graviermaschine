...
void StepperInit(ConsoleHandle_t consoleHandle, TIM_HandleTypeDef* tim1Handle, TIM_HandleTypeDef* tim4Handle, SPI_HandleTypeDef* hspi1)
{
L6474x_Platform_t p;
  ...
  tim1h = tim1Handle;
    tim4h = tim4Handle;
  stepperHandle = L6474_CreateInstance(&p, hspi1, NULL, tim1Handle);
